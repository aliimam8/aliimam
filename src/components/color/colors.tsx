...
function AIWheel() {
    ...
    return (
        <div className='flex flex-wrap justify-center'>
            <div className='flex flex-wrap  justify-center gap-8 bg-slate-100/10 shadow-2xl dark:bg-slate-900/10 border border-slate-200 dark:border-slate-800 py-10 px-10 rounded-3xl w-auto'>
