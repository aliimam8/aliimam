      ...
      <div className="relative aspect-square h-full max-h-[550px] w-full overflow-hidden">
        ...
        {images.length > 1 ? (
          <div className="absolute bottom-[10%] flex w-full justify-center">
            <div className="mx-auto flex h-12 items-center rounded-full border border-slate-200 bg-slate-200 text-slate-500/50 backdrop-blur dark:border-slate-800 dark:bg-slate-800/50">
              <Link
