...
import PostCards from '@/components/contentmdx/post-cards';
import GalleryCards from '@/components/contentmdx/gallery-cards';
...
export const GalleryFilteredPosts = (props: FilteredGalleryPostsProps) => {
  ...
  return (
    <>
      ...
      <div className="">
        {filteredPosts.length === 0 && (
          <div className="my-24 text-center text-xl">No Gallery found</div>
        )}
      </div>
