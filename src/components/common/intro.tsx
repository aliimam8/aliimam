...
export default function Intro() {
  ...
  return (
    <div
      ...
      id="intro"
    >
      <div className="mx-auto text-center flex px-8 my-10 md:my-20 max-w-7xl flex-col items-center justify-center text-3xl font-extrabold tracking-tighter md:text-6xl">
