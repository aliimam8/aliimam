...
import { type BlogPostCore, type AssetsPostCore,  type ColorsPostCore } from '@/types';

import PostCards from '@/components/common/post-cards';
import ColorsCards from '@/components/common/colors-cards';
import ColorsBox from '@/components/common/colors-box';
...
export const DColorsFilteredPosts = (props: FilteredColorsPostsProps) => {
  const { posts} = props;
  const [searchValue, setSearchValue] = React.useState('');
