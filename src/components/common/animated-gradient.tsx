...
export const AnimatedGradient = () => (
  <div
    style={{ position: "absolute", width: "100%", zIndex: "-50", opacity: 1 }}
  >
    <div
      style={{
        position: "relative",
  ...
  return (
    ...
    >
      <motion.path
        ...
        initial="initial"
        animate="animate"
        variants={variants({ colors: ["#003CFF", "#f50537", "#003CFF"] })}
      />
      <motion.path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        initial="initial"
        animate="animate"
        variants={variants({ colors: ["#D4FF00", "#f50537", "#D4FF00"] })}
      />
      <motion.path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        initial="initial"
        animate="animate"
        variants={variants({ colors: ["#FF0000", "#f50537", "#FF0000"] })}
      />
    </svg>
  )
}