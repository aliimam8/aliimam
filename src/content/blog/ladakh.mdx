---
title: How to build a blog using Next.js and MDX
date: '2022-08-22T00:00:00Z'
modifiedTime: '2023-08-27T00:00:00Z'
...
- `components/layout.js` - Wrap all components in a container (optional, just the style)
- `date/blog/*.mdx` - Blog Articles
- `lib/format-date.js` - Format the date as `MM DD, YYYY`
- `[slug].js` - article page, using [dynamic routes](https://nextjs.org/docs/routing/dynamic-routes)
...
<Tree
  data={[
    ...
    {
      name: 'lib',
      children: [{ name: 'format-date.js' }, { name: 'mdx.js' }]
    },
    {
      name: 'pages',
...
```js showLineNumbers title="lib/format-date.js"
...
This way, the simple Blog is finished.
